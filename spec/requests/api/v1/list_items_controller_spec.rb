...
#     before do
#       # Each user gets 4 default lists on creation
#     end

#     describe "GET /api/v1/default_list/:custom_list_id/list_items" do
#       context "with list items" do
#         before do
...
#     describe "POST /api/v1/default_list/:custom_list_id/list_items" do
#       let(:valid_params) { { list_item: { item_id: 550, item_type: "Movie" } } }
...
#     describe "DELETE /api/v1/default_list/:custom_list_id/list_items/:id" do
